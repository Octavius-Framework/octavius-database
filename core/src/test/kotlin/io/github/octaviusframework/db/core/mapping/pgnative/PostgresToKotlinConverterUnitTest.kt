...
class PostgresToKotlinConverterUnitTest {
    ...
    private val converter = PostgresToKotlinConverter(fakeTypeRegistry, Json)
    ...
    fun `should convert all enum types correctly`() {
        assertThat(converter.convert(GOLDEN_STRING_SINGLE_STATUS, getOid(QualifiedName("public","test_status")), options)).isEqualTo(
            TestStatus.Active)
        assertThat(converter.convert(GOLDEN_STRING_STATUS_ARRAY, getOid(QualifiedName("public","test_status", isArray = true)), options)).isEqualTo(listOf(
    ...
    fun `should convert composite person type`() {
        ...
        val result = converter.convert(GOLDEN_STRING_SINGLE_PERSON, getOid(QualifiedName("public","test_person")), options)
    ...
    fun `should convert an array of composite persons`() {
        ...
        val result = converter.convert(GOLDEN_STRING_PERSON_ARRAY, getOid(QualifiedName("public","test_person", isArray = true)), options)
        assertThat(result).isEqualTo(expected)
    }
    ...
    fun `should convert deeply nested project composite`() {
        ...
        val result = converter.convert(GOLDEN_STRING_PROJECT_DATA, getOid(QualifiedName("public","test_project")), options)
        assertThat(result).isEqualTo(expected)
    }
    ...
    fun `should convert an array of deeply nested projects`() {
        ...
        val result = converter.convert(GOLDEN_STRING_PROJECT_ARRAY, getOid(QualifiedName("public","test_project", isArray = true)), options) as List<TestProject>
