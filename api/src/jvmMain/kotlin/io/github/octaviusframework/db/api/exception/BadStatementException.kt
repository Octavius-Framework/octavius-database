...
enum class BadStatementExceptionMessage {
    ...
    /** Streaming query with fetchSize > 0 requires an active transaction. */
    STREAMING_REQUIRES_TRANSACTION,
...
private fun generateDeveloperMessage(
    ...
    return when (messageEnum) {
        ...
        BadStatementExceptionMessage.STREAMING_REQUIRES_TRANSACTION -> "Streaming query with fetchSize > 0 requires an active transaction to work correctly in PostgreSQL."
    }
}
